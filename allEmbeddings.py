...
G24.add_edge(1,2,weight=0.2)
G24.add_edge(2,3,weight=0.2)
G24.add_edge(3,4,weight=0.2)
G24.add_edge(4,1,weight=0.2)
G24.add_edge(1,5,weight=0.2)
G24.add_edge(2,5,weight=0.2)
G24.add_edge(3,5,weight=0.2)
G24.add_edge(4,5,weight=0.2)

print "Varun's Test Case"
generateAllEmbeddings(G22,G23)

print "Weird Test Case 1"
print findUpperBoundFeature(G22,G24)
